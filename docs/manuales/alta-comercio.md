...
![Home de Portal 659](capturas/01-home.png)
...
![Página de registro](capturas/03-register.png)
...
![Página de login](capturas/02-login.png)
...
![Dashboard - pestaña Pedidos](capturas/04-dashboard-pedidos.png)
...
![Menú "Más"](capturas/11-menu-mas.png)
...
![Configuración - datos del comercio](capturas/12-config-top.png)

### 5.2 Ubicación y horarios

Expandí **"Ubicación y horarios"** para cargar tu dirección y horarios de atención.

![Ubicación y horarios](capturas/14-config-ubicacion.png)
...
![Pago y entrega](capturas/15-config-pago.png)
...
![Configuración - menú](capturas/16-config-menu.png)
...
![Modal de compartir](capturas/17-share-modal.png)
...
![Micrositio del comercio](capturas/18-micrositio.png)

Si acceden con `?menu=1`, se abre directamente en la sección de menú:

![Micrositio - menú visible](capturas/19-micrositio-menu.png)

En mobile aparece un **botón fijo de WhatsApp** para que el cliente te escriba directo:

![Botón WhatsApp fijo](capturas/20-micrositio-wa.png)
