...
![Dashboard - pestaña Pedidos](capturas/21-pedidos-nuevo.png)
...
![Filtro "Todos" - todos los pedidos](capturas/05-pedidos-todos.png)
...
![Pedido nuevo - delivery](capturas/06-order-delivery-new.png)
...
![Acción de aceptar pedido](capturas/22-pedido-accion.png)

### 3.3 Preparando

Mientras cocinás, el pedido aparece en la pestaña **"Preparando"**.

![Pedido en preparación](capturas/08-order-preparing.png)

### 3.4 Listo para enviar

Cuando terminás, tocá **"Listo para envío"**. El pedido pasa a estado **"Listo"**.

![Pedido listo](capturas/09-order-ready.png)
...
![Pedido enviado](capturas/10-order-sent.png)
...
![Pedido con pago pendiente](capturas/07-order-transfer-pending.png)
...
![Pedido de mostrador](capturas/23-pedido-mostrador.png)
...
![Pedido de mesa](capturas/24-pedido-mesa.png)
...
![Comanda / KDS](capturas/25-comanda-kds.png)
...
![Mostrador / POS](capturas/26-mostrador-pos.png)
