        ...
        <div className="rounded-xl bg-muted/60 p-3 space-y-2">
          ...
          {salePrice != null && preview.perPortion > 0 && (
            <div className="flex items-center justify-between gap-2 text-sm">
              ...
              <span className="font-semibold tabular-nums">{formatMoney(suggestedPrice(preview.perPortion, tgt))}</span>
            </div>
          )}
...
// ---------------------------------------------------------------------------
// Tab Recetas: carta con semáforo + editor | biblioteca de insumos.
// ---------------------------------------------------------------------------
export function RecipeManager() {
  const [view, setView] = useState<"platos" | "insumos">("platos");
  ...
  return (
    <div className="space-y-4">
      ...
      <Input
        ...
        placeholder={view === "platos" ? "Buscar plato…" : "Buscar insumo…"}
        className="max-w-sm"
      />
