...
export function StickyStoreBar({
  ...
  useEffect(() => {
    ...
    if (!el) return;
      const obs = new IntersectionObserver(
        ...
        // 104px = altura del nav mobile completo (fila 1 h-14 = 56px + fila 2
        // ZoneSelector/Install ~48px). El nav está z-50 por encima.
  ...
  return (
    <div
      className={[
        "fixed top-[104px] left-0 right-0 z-40 h-12 sm:hidden",
